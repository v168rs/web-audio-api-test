...
var impulse_file = window.location.origin + "/" + path_prefix + "/snd/imp/impulse3.wav";
...
function add_convolution(bus_num, impulse = window.location.origin + "/" + path_prefix + "/snd/imp/impulse3.wav", loc = 1) {
...
//HTML5
function add_sampler(bus_num, sample=window.location.origin + "/" + path_prefix + "/snd/ocean_waves.wav") {
